...
class DirectoryItemsList extends Block {

    protected static $slug = 'directory-items-list';
    ...
    public static function renderCallback($attributes, $content) {
        ...
        $activeProPlugin = defined( 'CITADELAWP_PRO_PLUGIN' );
        ...
        <div 
            class="wp-block-citadela-blocks ctdl-directory-items-list <?php echo esc_attr( implode( " ", $classes ) );?>"
            ...
            <div class="citadela-block-articles <?php if( $args['useCarousel'] )  echo esc_attr( 'swiper-container' ); ?>">
                ...
                <?php
                    ...
                    if ( $attributes['pagination'] && $total_pages > 1 ) {
                        include dirname( __FILE__ ) . '/../../plugin/cpt/item/templates/parts/pagination.php';
                    }
                ?>
    ...
    private static function enqueueFrontendScript() {
        ...
        wp_enqueue_script( 'directory-items-list-block-frontend', $script_url, $script_dependencies, filemtime( $script_path ), false );
    }
}
