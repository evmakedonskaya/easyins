...
class PostsSearchForm extends Block {

    protected static $slug = 'posts-search-form';
    ...
    public static function renderCallback($attributes, $content) {
        ...
        $category = 'category';
        $location = 'citadela-post-location';
        ...
        if( $activeProPlugin ){
            ...
            if( $attributes['hideInputLocation'] ) {
                $classes[] = 'hidden-input-location';
                $args['hideInputLocation'] = true;
            }
        ...
        <div class="wp-block-citadela-blocks ctdl-posts-search-form <?php echo esc_attr( implode( ' ', $classes ) ); ?>">
