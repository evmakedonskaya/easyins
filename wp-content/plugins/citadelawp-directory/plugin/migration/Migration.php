...
class Migration
{
    ...
    public static function run()
    {
        ...
        register_activation_hook('citadelawp-directory/citadelawp-directory.php', [__CLASS__, 'activation']);
        register_deactivation_hook('citadelawp-directory/citadelawp-directory.php', [__CLASS__, 'deactivation']);
