        ...
        <div class="notice notice-success notice-large">
            <p>
                ...
                <?php 
                    ...
                    printf(esc_html__('%s has finished migration. All items, categories and locations from your previous AIT directory theme are now available for use with CitadelaWP Listing plugin.', 'citadela-directory' ), '<strong>CitadelaWP Listing plugin</strong>'); ?>
            </p>
        </div>
        <?php
