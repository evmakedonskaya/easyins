<?php
    ...
    $special_page_id = CitadelaDirectoryLayouts::getSpecialPageId('item-location');
...
<?php
	if ( is_active_sidebar( 'item-location-sidebar' ) && 'half-layout-template' !== get_post_meta( $special_page_id, '_wp_page_template', true ) ) :
?>
	<aside id="secondary" class="item-location-widget-area widget-area right-widget-area">
		<div class="widget-area-wrap">
			<?php dynamic_sidebar( 'item-location-sidebar' ); ?>
		</div>
	</aside>
<?php
	endif;
