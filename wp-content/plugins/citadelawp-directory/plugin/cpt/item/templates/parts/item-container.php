		...
		<div class="item-body">
			...
			<div class="item-footer" <?php echo $bordersStyle; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
				...
				<div class="item-data web" <?php echo $bordersStyle; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
					...
					<span class="values">
						<a href="<?php echo esc_url( $meta->web_url );?>" class="value" target="_blank" rel="nofollow" <?php echo $itemWebValueStyle; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php echo $webUrlLabel; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></a>
					</span>
				</div>
				<?php endif; ?>
					...
					<span class="values">
                        ...
                        ?>
						    <a
                                ...
                                class="value" <?php echo $itemCategoriesValueStyle; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                            >
