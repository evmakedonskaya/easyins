...
/**
 * CitadelaWP Listing Settings screen
 *
 */
...
class CitadelaDirectorySettings {
	...
	public static function createMenu(){
		$parentMenuItem = (object) array(
			'page_title'	=> esc_html__('CitadelaWP Listing', 'citadela-directory'),
			'menu_title'	=> esc_html__('CitadelaWP Listing', 'citadela-directory'),
	...
	public static function subscriptionsSection() {
		...
		<p>
			...
			<?php if( CitadelaDirectory::getInstance()->Subscriptions_instance->enabled_subscription_plugin ) : ?>
				<p><strong><?php esc_html_e("We've noticed WooCommerce Subscriptions plugin is active, subscriptions functionality from CitadelaWP Listing plugin is available.", 'citadela-directory'); ?></strong></p>
			<?php endif; ?>
