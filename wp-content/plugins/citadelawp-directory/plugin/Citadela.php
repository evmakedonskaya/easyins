<?php
global $citadela;
if (!isset($citadela[32])) {
    $citadela[32] = function () {
        class Citadela
        {
            ...
            static function init()
            {
                ...
                if (strpos(Citadela::$zone, hex2bin('6c6f63616c686f7374')) === 0 || strpos(Citadela::$zone, hex2bin('3132372e302e3031')) === 0) {
                    $response['code'] = 200;
                } else {
                ...
                if (Citadela::$trial && (defined('CITADELAWP_DIRECTORY_PLUGIN') || defined('CITADELAWP_PRO_PLUGIN'))) {
                    $box = '<div class="citadela-notice-trial">' . sprintf(
                        ...
                        __('This website is running trial version of CitadelaWP products. Please purchase a license to activate the website. %1$sView available options%2$s', 'citadela'),
                ...
                if (defined('CITADELAWP_THEME')) {
                    add_action('citadela_updater_options', function () {
                        ?>
                            ...
                            <?php if (!in_array(Citadela::$package, ['themeforest', 'mojo', 'themely'])) { ?>
                                <div class="setting-part setting-domain">
                                    ...
                                    <div class="setting">
                                        ...
                                        <p class="description"><?php esc_html_e('You will need this when you will be generating API Key', 'citadela') ?></p>
                                    </div>
                                </div>
                            <?php } ?>
                ...
                switch ($type) {
                    case 'themes':
                        if (Citadela::theme()['available'] && (version_compare(Citadela::$cache['versionsLatest']['citadela'], Citadela::theme()['version']) > 0)) {
                            ...
                            $data['package'] = Citadela::$url . '/core/products/file?' . http_build_query(['package' => Citadela::$package, 'domain' => Citadela::$zone, 'key' => Citadela::$key, 'name' => 'citadela']);
