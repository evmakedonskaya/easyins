...
class CitadelaDirectorySearch {
    ...
    public static function ctdl_check_list_users() {
	if ( ! current_user_can( 'list_users' ) ) {
		return new WP_Error( 'rest_forbidden', esc_html__( 'Permission denied.', 'citadela-directory' ), array( 'status' => 401 ) );
	}
	return true;
    }
    ...
    public static function registerRestRoutes()
    {
        ...
        register_rest_route( 'citadela-directory', '/users', [
            ...
            'permission_callback' => array(__CLASS__, 'ctdl_check_list_users'),
        ] );
