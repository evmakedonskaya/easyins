...
class CitadelaDirectorySpecialPages {
    ...
    public static function admin_init() {
        ...
        if( ! is_plugin_active( 'citadelawp-pro/citadelawp-pro.php' ) ){
    ...
    static function customize_title_on_edit(){
        ...
        $p->labels->name = esc_html__( 'CitadelaWP - Special Pages', 'citadela-directory' );
    ...
    public static function register_post_type() {
        ...
        register_post_type( 'special_page', [
            'labels'                => [
                ...
                'search_items'             => esc_html__( 'Search Special pages', 'citadela-directory' ),
    ...
    public static function menu() {
        ...
        $menu_item = [
			'page_title'	=> esc_html__( 'CitadelaWP Special Pages', 'citadela-directory' ),
			'menu_title'	=> esc_html__( 'CitadelaWP Special Pages', 'citadela-directory' ),
    ...
    public static function block_categories( $categories ) {
        $new_categories = [
            'citadela-directory-blocks' => [
                ...
                'title' => esc_html__( 'CitadelaWP Listing Blocks', 'citadela-directory' ),
            ],

            'citadela-posts-blocks' => [
                'slug' => 'citadela-posts-blocks',
                'title' => esc_html__( 'CitadelaWP Posts Blocks', 'citadela-directory' ),
            ],
        ];
