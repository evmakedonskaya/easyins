...
/*
 Plugin Name: CitadelaWP Pro
 Plugin URI: https://www.ait-themes.club/citadela-plugins/citadela-pro/
 Description: Ready to use layouts and blocks for CitadelaWP with many customization options.
 Version: 6.2.5
 Author: AitThemes
...
define( 'CITADELAWP_PRO_PLUGIN', true );
define( 'CITADELAWP_PRO_PLUGIN_FILE', __FILE__ );
