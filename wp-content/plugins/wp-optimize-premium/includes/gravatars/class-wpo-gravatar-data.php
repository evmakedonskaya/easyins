...
class WPO_Gravatar_Data {
	 ...
	 */
	public function __construct($url, $id_or_email) {
		$this->remote_url = $url;
	 ...
	 */
	private function is_gravatar_already_cached() {
	 ...
	 * @return bool
	 */
	private function is_jpeg_gravatar_exists() {
	 ...
	 * @return bool
	 */
	private function is_png_gravatar_exists() {
	 ...
	 * @return string
	 */
	private function get_cached_gravatar_url() {
	...
	private function get_extension() {
		...
		return in_array($ext, array('jpeg', 'jpg')) ? '.jpg' : ".$ext";
	}
}
