...
class WPO_Yoast_SEO {
	...
	public function get_posts_content_images($images, $post_id) {
		$yoast_seo_facebook_images = get_post_meta($post_id, '_yoast_wpseo_opengraph-image-id');
		$yoast_seo_twitter_images = get_post_meta($post_id, '_yoast_wpseo_twitter-image-id');
