...
class Citadela_Theme {
	...
	*/
	...
	public function is_active_pro_plugin(){
		return defined( 'CITADELAWP_PRO_PLUGIN' ) ? true : false;
	}

	public function is_active_directory_plugin(){
		return defined( 'CITADELAWP_DIRECTORY_PLUGIN' ) ? true : false;
	}

	public function is_active_blocks_plugin(){
		return defined( 'CITADELAWP_BLOCKS_PLUGIN' ) ? true : false;
	}
	...
	public function after_switch_theme(){
		if (!get_theme_mod('citadela_setting_hideTaglineSitetitle')) {
			$citadela_options = get_option( "theme_mods_citadela");
			if ($citadela_options) {
				update_option( "theme_mods_citadelawp", $citadela_options );
			}
		}
