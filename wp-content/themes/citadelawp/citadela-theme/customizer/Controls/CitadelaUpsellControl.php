...
class CitadelaUpsellControl extends \WP_Customize_Control {
    ...
    public function content_template() {
        ?>
        <div class="ctdl-info">
        	<p><?php esc_html_e('CitadelaWP is a multi-purpose WordPress theme created by AitThemes. You can use it on your commercial or non-commercial website.', 'citadela'); ?></p>
        	<p><strong><?php esc_html_e('We have also created premium CitadelaWP plugins, that will shift your website to the whole new level.', 'citadela'); ?></strong></p>
		</div>
