...
<div class="citadela-screen-section ctdl-section-space">
	<h2 class="citadela-screen-title"><?php esc_html_e('Ready to use CitadelaWP layouts', 'citadela'); ?></h2>
	<?php if ($package === 'themeforest') { ?>
		<p class="citadela-screen-subtitle"><?php esc_html_e('You can import any of these layouts to start building your website. Layout can be imported using CitadelaWP Pro plugin. Layout packages can be found in the main zip file you can download from Themeforest.', 'citadela'); ?></p>
	<?php } else { ?>
		<p class="citadela-screen-subtitle"><?php esc_html_e('You can import any of these layouts to start building your website. Layout can be imported using CitadelaWP Pro plugin.', 'citadela'); ?></p>
	<?php } ?>
</div>
		...
		<div class="ctdl-screen-item">
			...
			<div class="ctdl-screen-body">
				...
				<div class="ctdl-screen-content">
					...
					<p class="ctdl-item-subtitle"><?php echo esc_html(str_replace('CitadelaWP ', '', $layout['display_name']) . ' ' .  __( 'Layout Pack', 'citadela'));  ?></p>
				</div>
			</div>
			<?php if ($package !== 'themeforest') { ?>
			</a>
