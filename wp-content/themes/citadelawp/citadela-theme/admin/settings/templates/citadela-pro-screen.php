	...
	<div class="citadela-screen-header ctdl-active">
		<div class="citadela-screen-header-wrap">
			<div class="ctdl-brand">
				<h1><?php esc_html_e('CitadelaWP Dashboard', 'citadela'); ?></h1>
				<p><?php esc_html_e('by AitThemes', 'citadela'); ?></p>
			</div>
			<div class="ctdl-brand-desc">
				<p><?php esc_html_e('Thank you for using premium CitadelaWP plugins. As paying AitThemes customer you have access to our support forum and documentation.', 'citadela'); ?></p>
			</div>
		</div>
	</div>

	<div class="citadela-screen-holder ctdl-active ctdl-api-settings-active <?php echo Citadela::$package !== 'themeforest' && defined('CITADELAWP_PRO_PLUGIN') ? 'ctdl-pro-active' : ''; ?>">
		<div class="ctdl-screen-items">
        	...
        	<div class="ctdl-screen-item ctdl-status <?php echo (Citadela::$trial || !Citadela::$allowed) ? 'ctdl-trial' : 'ctdl-activated'; ?>">
				<div class="ctdl-screen-body">
					<div class="ctdl-screen-content">
						<h2 class="ctdl-item-title"><?php echo (Citadela::$trial || !Citadela::$allowed) ? esc_html_e('CitadelaWP Activation', 'citadela') : esc_html_e('CitadelaWP Activated', 'citadela'); ?></h2>
						<p class="ctdl-item-desc"><?php 
							echo wp_kses_post(Citadela::$trial ?
								sprintf(/* translators: 1. Start html anchor tag, 2. End html anchor tag  */ __('You can test a full version of premium CitadelaWP features for free. For live website, you need to purchase a license and a valid API key for this domain. %1$sPurchase CitadelaWP License%2$s.', 'citadela'), '<a href="https://www.ait-themes.club/">', '</a>') :
								sprintf(/* translators: %s - activation key type: Purchase Code or API Key */ __('You need to enter %1$s in order to use premium CitadelaWP features. One %1$s will allow you to run CitadelaWP on one URL. It will also ensure automatic updates for theme and plugins.', 'citadela'), in_array(Citadela::$package, ['themeforest', 'mojo', 'themely']) ? __('Purchase Code', 'citadela') : __('API Key', 'citadela'))
							); ?></p>
					</div>
				</div>
			</div>
			...
			<?php if (Citadela::$package !== 'themeforest' && defined('CITADELAWP_PRO_PLUGIN')) { ?>

			<div class="ctdl-screen-item ctdl-layouts">
				<div class="ctdl-screen-body">
					<div class="ctdl-screen-content">
						<h2 class="ctdl-item-title"><?php esc_html_e('CitadelaWP Layouts', 'citadela'); ?></h2>
						<p class="ctdl-item-desc"><?php esc_html_e('With our CitadelaWP WordPress theme layouts, you don’t need to hire a designer to help you make your website look professional. Our designers have already made that for you. CitadelaWP WordPress Layouts are carefully designed to suit your business. All you need is to change the content to present your work. It saves you time and money.', 'citadela'); ?></p>
						<p class="ctdl-item-cta"><a href="<?php echo esc_url( admin_url( "admin.php?page=citadela-pro-settings&tab=layouts" ) ) ?>"><?php esc_html_e('Explore CitadelaWP Layouts', 'citadela'); ?></a></p>
					</div>
				</div>
			</div>
