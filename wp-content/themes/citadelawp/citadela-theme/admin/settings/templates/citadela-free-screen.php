	...
	<div class="citadela-screen-header ctdl-free">
		<div class="citadela-screen-header-wrap">
			<div class="ctdl-intro">
				<h1><?php esc_html_e('Thank you for installing CitadelaWP Theme by AitThemes', 'citadela'); ?></h1>
				<p class="ctdl-main-desc"><?php esc_html_e('CitadelaWP is a multi-purpose WordPress theme. You can use it on your commercial or non-commercial website. Our premium plugins will shift your website to the whole new level!', 'citadela'); ?></p>
			</div>
		</div>
	</div>
					...
					<div class="ctdl-screen-content">
                    	...
                    	<div class="ctdl-install-screen">
                    		<div class="ctdl-install-button">
                    			<a class="citadela-installation" href="<?php echo admin_url('admin-ajax.php?action=citadela-installation'); ?>"><?php esc_html_e('Install CitadelaWP Plugins', 'citadela'); ?></a>
							...
							<p class="ctdl-item-desc"><?php esc_html_e('Extend the functionality of the CitadelaWP theme with the premium CitadelaWP plugins.', 'citadela'); ?></p>
						</div>
        	...
        	<div class="ctdl-screen-item ctdl-pro-info">
				<div class="ctdl-screen-body">
					<div class="ctdl-screen-content">
						...
						<h2 class="ctdl-item-title"><?php esc_html_e('CitadelaWP Pro', 'citadela'); ?></h2>
			...
			<div class="ctdl-screen-item ctdl-dir-info">
				<div class="ctdl-screen-body">
					<div class="ctdl-screen-content">
						...
						<span class="ctdl-item-label"><?php esc_html_e('Premium Plugin', 'citadela'); ?></span>
						<h2 class="ctdl-item-title"><?php esc_html_e('CitadelaWP Listing', 'citadela'); ?></h2>
			...
			<div class="ctdl-screen-item ctdl-layouts-info">
				<div class="ctdl-screen-body">
					<div class="ctdl-screen-content">
						...
						<p class="ctdl-item-desc"><?php esc_html_e('Ready-to-use one click install CitadelaWP layouts to start your new website in minutes.', 'citadela'); ?></p>
						<span class="ctdl-info-icon"></span>
