...
class Citadela_Theme_Settings {
	...
	public static function create_menu() {
		add_menu_page(
			esc_html__('CitadelaWP Theme', 'citadela'),
			esc_html__('CitadelaWP Theme', 'citadela'),
			'edit_dashboard',
			'citadela-settings',
	...
	{
		if ((class_exists('Citadela') && in_array(Citadela::$package, ['themeforest', 'mojo', 'themely'])) || defined('CITADELA_BLOCKS_PLUGIN') || defined('CITADELAWP_DIRECTORY_PLUGIN') || defined('CITADELAWP_PRO_PLUGIN')) {
